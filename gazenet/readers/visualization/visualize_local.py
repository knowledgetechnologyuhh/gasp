...
if __name__ == '__main__':
    ...
    video = SampleRegistrar.registry[sampler](video_source, w_size=1, width=width, height=height, enable_audio=play_audio)
    audio_streamer = None
    for i in range(len(video)):
        view(plotter, video, n_frames=500, enable_audio=play_audio, video_properties=sampler_properties)
        next(video)