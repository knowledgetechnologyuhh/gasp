# TODO (fabawi): move Alexnet to the shared components package
import argparse
import os
import shutil
import time
...
class HeadPose(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        self.alexnet = HeadPoseAlexnet(num_classes=num_classes)
...
class VideoGaze(nn.Module):
    def __init__(self, batch_size=200, side=20):
        ...
        self.projection = ConeProjection(batch_size)
    ...
    def forward(self, source,target,face,eyes):
        ...
        # or min max normalize the output
