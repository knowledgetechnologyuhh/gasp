...
MODEL_URLS = {"mobilenetv2": "https://github.com/rdroste/unisal/raw/master/unisal/models/weights/mobilenet_v2.pth.tar"}
...
class MobileNetV2(nn.Module):
    def __init__(self, widen_factor=1., pretrained=True,
        ...
        if self.pretrained:
            ...
            self.load_state_dict(model_zoo.load_url(MODEL_URLS['mobilenetv2']), strict = False)
        else:
            self._initialize_weights()
